...
#TODO
    ...
    for ship in range(len(ship_health)):
        ...
        ship_no = ship+1
        battleship.addShipToShipGrid(ship_length, ship_no, shipgrid)

    return shipgrid


def debugCheckShipDistribution(rows, cols, runs):
...
rows, cols = 10, 10
debugCheckShipDistribution(rows, cols, 100000)
debugCheckShipDistribution(15, 15, 400000)
debugTestGame(1000)
